...
{
    public class NeuralColorQuantizer : IColorQuantizer
    {
        #region | Constants |
        ...
        private readonly Int32[] bias = new Int32[NetworkSize];
        private readonly Int32[] frequency = new Int32[NetworkSize];
        private readonly Int32[] networkIndexLookup = new Int32[256];
        private readonly Int32[] radiusPower = new Int32[DefaultRadius];
