...
namespace SimplePaletteQuantizer.ColorCaches.LocalitySensitiveHash
{
    public class LshColorCache : BaseColorCache
    {
        ...
        private const Single NormalizedDistanceRGB = 1.0f / 768.0f; // 256*256*3 (RGB) = 196608 / 768.0f
        private const Single NormalizedDistanceHSL = 1.0f / 872.0f; // 360*360 (H) + 256*256*2 (SL) = 260672 / 872.0f
        private const Single NormalizedDistanceLab = 1.0f / 260.0f; // 13*13*3 = 507 / 300.0f
        ...
        private Int64 GetColorBucketIndex(Color color)
        {
            ...
            Single distance = componentA + componentB + componentC;
        ...
        protected override void OnGetColorPaletteIndex(Color color, out Int32 paletteIndex)
        {
            ...
            {
                Int32 index = 0, colorIndex;
                ColorModelHelper.GetEuclideanDistance(color, ColorModel, bucket.Colors.Values.ToList(), out colorIndex);
