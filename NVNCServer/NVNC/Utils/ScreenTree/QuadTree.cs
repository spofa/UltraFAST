...
namespace NVNC.Utils.ScreenTree
{
    public class QuadTree
    {
        ...
        public QuadTree(Rectangle2 screenSize, int[] pixels, int minTileHeight = 64, int minTileWidth = 64)
        {
            ...
            a.Stop();
            Console.WriteLine("TRACE: " +"Found lowest in:" + a.ElapsedMilliseconds + "ms");
            ...
            signal.WaitOne();
            a.Stop();
            Console.WriteLine("TRACE: " +"Processed nodes in:" + a.ElapsedMilliseconds + "ms");
            ...
            //}
            t.Stop();
            Console.WriteLine("TRACE: " +"QuadTree construction: " + t.ElapsedMilliseconds + "ms");
        }
