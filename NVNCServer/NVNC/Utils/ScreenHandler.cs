...
namespace NVNC.Utils
{
    ...
    public class ScreenHandler
    {
        ...
        public ICollection<QuadNode> GetChange()
        {
            ...
            previous = current;
            r.Stop();
            //Console.WriteLine("TRACE: " +"Changes processed in: " + r.ElapsedMilliseconds);
        ...
        private void RefreshCurrent()
        {
            ...
            c.Stop();
            Console.WriteLine("TRACE: " +"Refresh grab done in: " + c.ElapsedMilliseconds + "ms");

            LastPixels = pixels;
            current = new QuadTree(Bounds, pixels);

            o.Stop();
            Console.WriteLine("TRACE: " +"Complete refresh done in: " + o.ElapsedMilliseconds + "ms");
        }
